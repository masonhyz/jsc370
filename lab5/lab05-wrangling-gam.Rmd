...
a, t, w has the median atmospheric pressure, wind speed, and temperature respectively.

Station 723119 has all three medians.
...
The above two plots visualizes the two models. The cubic spline model works best because the adjusted R squared is higher than that of the linear smooth line. This is because of the fact that the model has more parameter hence fits better with data patterns.
